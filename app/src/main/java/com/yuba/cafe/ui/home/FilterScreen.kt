...
import com.yuba.cafe.ui.components.FilterChip
...
fun FilterScreen(
    ...
    var sortState by remember { mutableStateOf(com.yuba.cafe.model.SnackRepo.getSortDefault()) }
    var maxCalories by remember { mutableStateOf(0f) }
    val defaultFilter = com.yuba.cafe.model.SnackRepo.getSortDefault()

    Dialog(onDismissRequest = onDismiss) {

        val priceFilters = remember { com.yuba.cafe.model.SnackRepo.getPriceFilters() }
        val categoryFilters = remember { com.yuba.cafe.model.SnackRepo.getCategoryFilters() }
        val lifeStyleFilters = remember { com.yuba.cafe.model.SnackRepo.getLifeStyleFilters() }
        JetsnackScaffold(
            topBar = {
                TopAppBar(
                    navigationIcon = {
...
@Composable
fun FilterChipSection(title: String, filters: List<com.yuba.cafe.model.Filter>) {
...
@Composable
fun SortFiltersSection(sortState: String, onFilterChange: (com.yuba.cafe.model.Filter) -> Unit) {
...
@Composable
fun SortFilters(
    sortFilters: List<com.yuba.cafe.model.Filter> = com.yuba.cafe.model.SnackRepo.getSortFilters(),
    sortState: String,
    onChanged: (com.yuba.cafe.model.Filter) -> Unit
) {
